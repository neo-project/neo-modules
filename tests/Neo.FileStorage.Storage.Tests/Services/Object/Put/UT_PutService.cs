...
using static Neo.FileStorage.Storage.Utils.Utils;
...
namespace Neo.FileStorage.Storage.Tests.Services.Object.Put
{
    ...
    public class UT_PutService
    {
        ...
        public void TestCompleteObjectLocal()
        {
            ...
            var nodeAddr = "/ip4/0.0.0.0/tcp/8080";
            ...
            localInfo.Addresses = new() { localAddr };
            TestLocalObjectStore localStore = new();
            TokenStore ts = new();
            KeyStore ks = new(key, ts);
            ...
            containerSource.Containers[cid] = container;
            API.Netmap.NodeInfo ni = new();
            ni.Addresses.Add(nodeAddr);
