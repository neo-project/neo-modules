    ...
    public class UT_MetaBase
    {
        ...
        public void TestPutBlobovnicaUpdate()
        {
            ...
            try
            {
                ...
                mb.Put(obj1, bid);
                Assert.IsTrue(mb.IsSmall(obj1.Address, out var fbid));
                Assert.AreEqual(((byte[])bid).ToHexString(), ((byte[])fbid).ToHexString());
                var obj2 = RandomObject();
                mb.Put(obj2);
                Assert.IsFalse(mb.IsSmall(obj2.Address, out fbid));
            }
            finally
            {
                Directory.Delete(path, true);
        ...
        public void TestSelectRootPhyParent()
        {
            ...
            try
            {
                ...
                //regular objects
                fs = new();
                fs.AddFilter(SearchRequest.Types.Body.Types.Filter.FilterHeaderObjectType, ObjectType.Regular.String(), API.Object.MatchType.StringEqual);
                list = mb.Select(cid, fs);
                ...
                Assert.IsTrue(list.Contains(parent.Address));
                fs = new();
                fs.AddFilter(SearchRequest.Types.Body.Types.Filter.FilterHeaderObjectType, ObjectType.Regular.String(), API.Object.MatchType.StringNotEqual);
                list = mb.Select(cid, fs);
                ...
                //tombstone objects
                fs = new();
                fs.AddFilter(SearchRequest.Types.Body.Types.Filter.FilterHeaderObjectType, ObjectType.Tombstone.String(), API.Object.MatchType.StringEqual);
                list = mb.Select(cid, fs);
                Assert.AreEqual(1, list.Count);
                Assert.IsTrue(list.Contains(ts.Address));
                fs = new();
                fs.AddFilter(SearchRequest.Types.Body.Types.Filter.FilterHeaderObjectType, ObjectType.Tombstone.String(), API.Object.MatchType.StringNotEqual);
                list = mb.Select(cid, fs);
                ...
                fs = new();
                fs.AddFilter(SearchRequest.Types.Body.Types.Filter.FilterHeaderObjectType, ObjectType.StorageGroup.String(), API.Object.MatchType.StringEqual);
                list = mb.Select(cid, fs);
                Assert.AreEqual(1, list.Count);
                Assert.IsTrue(list.Contains(sg.Address));
                fs = new();
                fs.AddFilter(SearchRequest.Types.Body.Types.Filter.FilterHeaderObjectType, ObjectType.StorageGroup.String(), API.Object.MatchType.StringNotEqual);
                list = mb.Select(cid, fs);
                Assert.AreEqual(6, list.Count);
                Assert.IsTrue(list.Contains(small.Address));
                Assert.IsTrue(list.Contains(left.Address));
        ...
        public void TestIsSmall()
        {
            ...
            try
            {
                ...
                var obj2 = RandomObject();
                BlobovniczaID bid = new byte[] { 1, 2, 3, 4 };
                Assert.IsFalse(mb.IsSmall(obj1.Address, out _));
                mb.Put(obj1, bid);
                mb.Put(obj2);
                Assert.IsFalse(mb.IsSmall(obj2.Address, out _));
                Assert.IsTrue(mb.IsSmall(obj1.Address, out var b));
                Assert.AreEqual(((byte[])bid).ToHexString(), ((byte[])b).ToHexString());
            }
            finally
            {
                Directory.Delete(path, true);
