...
namespace Neo.Network.RPC.Tests
{
    ...
    public class UT_WalletAPI
    {
        ...
        public async Task TestGetUnclaimedGas()
        {
            ...
            var balance = await walletAPI.GetUnclaimedGas(address1);
        ...
        public async Task TestGetNeoBalance()
        {
            ...
            var balance = await walletAPI.GetNeoBalance(address1);
        ...
        public async Task TestGetGasBalance()
        {
            ...
            var balance = await walletAPI.GetGasBalance(address1);
            Assert.AreEqual(1.1m, balance);
        }
        ...
        public async Task TestGetTokenBalance()
        {
            ...
            var balance = await walletAPI.GetTokenBalance(UInt160.Zero.ToString(), address1);
