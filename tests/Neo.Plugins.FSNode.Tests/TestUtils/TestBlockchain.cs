...
namespace Neo.Plugins.FSStorage
{
    public static class TestBlockchain
    {
        ...
        private static void DeployContract(SnapshotView snapshot,string contractName, string nefFilePath,string manifestFilePath,UInt160 sender,out UInt160 contractHash) {
            ...
            contractHash = SmartContract.Helper.GetContractHash(sender, nef.Script);
        ...
        private static void ExecuteScript(SnapshotView snapshot, string functionName, byte[] script,UInt160 sender) {
