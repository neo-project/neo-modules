    ...
    public class UT_MetaBase
    {
        ...
        public void TestDelete()
        {
            ...
            try
            {
                ...
                Assert.ThrowsException<FileStorage.LocalObjectStorage.SplitInfoException>(() => mb.Delete(parent.Address));
        ...
        public void TestDeleteAllChildren()
        {
            ...
            try
            {
                ...
                mb.Put(child1);
                mb.Put(child2);
                Assert.ThrowsException<FileStorage.LocalObjectStorage.SplitInfoException>(() => mb.Exists(parent.Address));
        ...
        public void TestExists()
        {
            ...
            try
            {
                ...
                #region merge split info
                {
                    ...
                    {
                        Assert.IsTrue(e is FileStorage.LocalObjectStorage.SplitInfoException);
                        var spie = e as FileStorage.LocalObjectStorage.SplitInfoException;
        ...
        public void TestGet()
        {
            ...
            try
            {
                ...
                {
                    Assert.IsTrue(e is FileStorage.LocalObjectStorage.SplitInfoException);
                    var sie = e as FileStorage.LocalObjectStorage.SplitInfoException;
