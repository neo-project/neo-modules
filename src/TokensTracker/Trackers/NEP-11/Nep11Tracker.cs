...
namespace Neo.Plugins.Trackers.NEP_11
{
    class Nep11Tracker : TrackerBase
    {
        ...
        {
            if (!_shouldTrackHistory) throw new RpcException(RpcErrorFactory.NewError(RpcErrorCode.MethodNotFound));
            ...
            if (endTime < startTime) throw new RpcException(RpcErrorFactory.NewError(RpcErrorCode.InvalidParams));
