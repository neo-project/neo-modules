...
namespace Neo.FileStorage.Storage.Services
{
    public class ResponseService
    {
        ...
        protected RequestResponseStream CreateRequestStream(Func<IRequest, bool> sender, Func<IResponse> closer, Action disposer)
        {
            return new()
            {
    ...
    public sealed class RequestResponseStream : IRequestStream
    {
        ...
        public Func<IRequest, bool> Sender { get; init; }
