    ...
    public sealed partial class MB : IDisposable
    {
        ...
        public MB(string p)
        {
            ...
            matchers = new()
            {
                ...
                { MatchType.CommonPrefix, StringCommonPrefixMatcher }
            };
        }
        ...
        private bool StringCommonPrefixMatcher(string key, byte[] value, string filter)
        {
            return StringifyValue(key, value).StartsWith(filter);
        }
