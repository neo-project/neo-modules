...
namespace Neo.Network.RPC.Models
{
    public class RpcNep17Transfers
    {
        ...
        public JObject ToJson()
        {
            ...
            json["address"] = UserScriptHash.ToAddress(Utility.ProtocolSettings.AddressVersion);
            return json;
        }
    ...
    public class RpcNep17Transfer
    {
        ...
        public JObject ToJson()
        {
            ...
            json["transferaddress"] = UserScriptHash?.ToAddress(Utility.ProtocolSettings.AddressVersion);
