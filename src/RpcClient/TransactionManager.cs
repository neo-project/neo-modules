...
{
    public class MakeTransactionContext
    {
        ...
        public MakeTransactionContext(RpcClient rpcClient, byte[] script, Signer[] signers = null, TransactionAttribute[] attributes = null)
        {
        ...
        public MakeTransactionContext AddSignature(KeyPair key)
        {
        ...
        public MakeTransactionContext AddMultiSig(KeyPair key, int m, params ECPoint[] publicKeys)
        {
        ...
        public MakeTransactionContext AddMultiSig(KeyPair[] keys, int m, params ECPoint[] publicKeys)
        {
            Contract contract = Contract.CreateMultiSigContract(m, publicKeys);
        ...
        public MakeTransactionContext AddWitness(Contract contract, params object[] parameters)
        {
            QueueWork(() => {
        ...
        public MakeTransactionContext AddWitness(UInt160 scriptHash, params object[] parameters)
        {
