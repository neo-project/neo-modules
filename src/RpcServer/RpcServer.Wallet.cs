...
namespace Neo.Plugins
{
    partial class RpcServer
    {
        ...
        [RpcMethod]
        public virtual JObject CloseWallet(JArray _params)
        {
            wallet = null;
            return true;
        }
        ...
        [RpcMethod]
        public virtual JObject DumpPrivKey(JArray _params)
        {
            CheckWallet();
        ...
        [RpcMethod]
        public virtual JObject GetNewAddress(JArray _params)
        {
            CheckWallet();
        ...
        [RpcMethod]
        public virtual JObject GetWalletBalance(JArray _params)
        {
            CheckWallet();
        ...
        [RpcMethod]
        public virtual JObject GetWalletUnclaimedGas(JArray _params)
        {
            CheckWallet();
        ...
        [RpcMethod]
        public virtual JObject ImportPrivKey(JArray _params)
        {
            CheckWallet();
        ...
        [RpcMethod]
        public virtual JObject CalculateNetworkFee(JArray _params)
        {
        ...
        [RpcMethod]
        public virtual JObject ListAddress(JArray _params)
        {
            CheckWallet();
        ...
        [RpcMethod]
        public virtual JObject OpenWallet(JArray _params)
        {
        ...
        [RpcMethod]
        public virtual JObject SendFrom(JArray _params)
        {
            CheckWallet();
        ...
        [RpcMethod]
        public virtual JObject SendMany(JArray _params)
        {
            CheckWallet();
            int to_start = 0;
            UInt160 from = null;
        ...
        [RpcMethod]
        public virtual JObject SendToAddress(JArray _params)
        {
            CheckWallet();
            UInt160 assetId = UInt160.Parse(_params[0].AsString());
