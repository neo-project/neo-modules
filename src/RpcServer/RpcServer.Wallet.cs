...
namespace Neo.Plugins
{
    partial class RpcServer
    {
        ...
        private JObject SendFrom(JArray _params)
        {
            ...
            UInt160 from = UInt160.Parse(_params[1].AsString());
            UInt160 to = UInt160.Parse(_params[2].AsString());
        ...
        private JObject SendMany(JArray _params)
        {
            ...
            {
                from = UInt160.Parse(_params[0].AsString());
                to_start = 1;
            }
            ...
            for (int i = 0; i < to.Count; i++)
            {
                ...
                outputs[i] = new TransferOutput
                {
                    ...
                    ScriptHash = UInt160.Parse(to[i]["address"].AsString())
                };
